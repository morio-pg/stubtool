  ...
  <div id="container">
    ...
    <nav class="breadcrumb" aria-label="breadcrumbs">
      <ul>
        ...
        <li class="is-active"><a href="#" aria-current="page">Cretae</a></li>
      </ul>
    </nav>
      ...
      <form @submit.prevent="validateBeforeSubmit">
        ...
        <b-field horizontal
          ...
          <div class="field is-grouped">
            <p class="control">
              <button type="submit" class="button is-success">作成する</button>
            </p>
            <p class="control">
          ...
          axios
            ...
            .then(
              function(responce) {
                ...
                this.$router.push({
                  name: "Detail",
                  params: { stubId: responce.data.stubId }
                });
              }.bind(this)
            )
            .catch(
